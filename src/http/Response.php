...
use Scar\http\Concern\CookiesTrait;
use Scar\http\Concern\MessageTrait;
use Scar\http\Contract\ResponseFormatterInterface;
use Scar\http\Contract\ResponseInterface;
use Scar\http\Stream\Stream;
...
class Response implements ResponseInterface
{
	 ...
	 * @param \Swoole\Http\Response $coResponse
	 *
	 * @return \Scar\http\Response
	 */
	...
	/**
	 * Quick send response
	 * @param \Scar\http\Response|null $response
	 *
	 * @throws \ReflectionException
	 */
