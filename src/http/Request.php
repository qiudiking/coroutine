...
use function substr;
use Scar\http\Concern\InteractsWithInput;
use Scar\http\Contract\RequestParserInterface;
use Scar\http\Contract\ServerRequestInterface;
use Scar\http\Helper\HttpHelper;
use Scar\http\Stream\Stream;
use Scar\http\Uri\Uri;
...
class Request extends PsrRequest implements ServerRequestInterface
{
	 ...
	 * @param \Swoole\Http\Request $coRequest
	 *
	 * @return \Scar\http\Request
