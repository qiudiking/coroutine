...
class BelongsToMany extends Relation
{
    ...
    public function __construct(Model $parent, $model, $table, $foreignKey, $localKey)
    {
        ...
        if ('Scar\model\Pivot' == get_class($this->pivot)) {
     ...
     * @return false|\PDOStatement|string|\Scar\Collection
     */
